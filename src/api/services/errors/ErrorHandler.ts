...
class ErrorHandler {
    ...
    logAndCreateBadRequest(route: string, pMsg?: string) {
        ...
        const error = new this.resitfyErrors.BadRequestError(msg);
    ...
    logAndCreateUnautorized(route: string, pMsg?: string) {
        ...
        const error = new this.resitfyErrors.UnauthorizedError(msg);
    ...
    logAndCreateInvalidCredentials(route: string, pMsg?: string) {
        ...
        const error = new this.resitfyErrors.InvalidCredentialsError(msg);
    ...
    logAndCreateNotFound(route: string, pMsg?: string) {
        ...
        const error = new this.resitfyErrors.NotFoundError(msg);
